...
function HomePage() {
    ...
    useEffect(() => {
        ...
        Api.getAllItemStacks(true, abortController.signal)
            .then(response => {
            ...
            <UserConsumer>
                {
                    (userContext => {
                        ...
                        if(itemStacks.length === 0) {
                            return (
                                <div>
                                    <div className="page-title">В вашем списке пока нет ни одного продукта!</div>
                                    <div className="links-row">
                                        <a href="/item-stack/new" className="link">Добавить</a>
                                        <a href="/sync" className="link">Синхронизировать</a>
                                    </div>
                                </div>
                            );
                        }
                        ...
                        return (
                            <React.Fragment>
                                <div>
                                    <div className="page-title">Это список ваших продуктов!</div>
                                    <div className="links-row">
                                        <a href="/item-stack/new" className="link">Добавить</a>
                                        <a href="/sync" className="link">Синхронизировать</a>
                                    </div>
                                    ...
                                    <div className="products-table">
...

                                        {
                                            itemStacks.map((itemStack) => {
                                                ...
                                                return (
                                                    <a className={"table-row" + (isExpired ? " expired" : "")} href={"/item-stack/" + itemStack["id"]}>
...
export default inCage(withHeader(HomePage));